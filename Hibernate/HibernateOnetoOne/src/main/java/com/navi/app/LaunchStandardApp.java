...
import com.navi.model.Answer;
import com.navi.model.Question;
...
public class LaunchStandardApp
{
	...
	public static void main(String[] args) 
	{
		...
		answer2.setId(2);
		answer2.setAnswer("It is a specification used to persist" 
		                 + "data between object and relational database");
