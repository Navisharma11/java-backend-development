package com.navisharma.SecurityProject01.rest;

import com.navisharma.SecurityProject01.model.Alien;
...
{
    List<Alien> list = new ArrayList<>(List.of(new Alien(1,"Rohan","Bengaluru"),new Alien(2,"Rohit","Delhi"),new Alien(3,"Ramesh","Mumbai")));
